...
**/
/**
 * A basic web browser can be written in a couple of hundred lines of code if you have 
 * a GUI component that renders HTML, which Java does.
 * A web server is a server program that waits for incoming requests on the HTTP port 
 * and acts on those to send the contents of local files back to the requestor.
 * article http://www.informit.com/articles/article.aspx?p=26316&seqNum=5
 */
